# -*- coding: utf-8 -*-
"""django-zip-stream documentation build configuration file."""
import os
import re

# Minimal Django settings. Required to use sphinx.ext.autodoc, because
# django-zip-stream depends on Django...
...
project = u'django-zip-stream'
project_slug = re.sub(r'([\w_.-]+)', u'-', project)
copyright = u'2016, Travis Cunningham'
author = u'Travis Cunningham'
...
latex_documents = [
    ('index', u'{project}.tex'.format(project=project_slug),
     u'{project} Documentation'.format(project=project), author, 'manual'),
]
...
man_pages = [
    ('index', project, u'{project} Documentation'.format(project=project),
     [author], 1)
]
...
texinfo_documents = [
    ('index', project_slug, u'{project} Documentation'.format(project=project),
